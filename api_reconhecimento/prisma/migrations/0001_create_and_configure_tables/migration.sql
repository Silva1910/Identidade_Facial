...
-- Criando Chave Primária 
ALTER TABLE `REGISTRO_PONTO` PRIMARY KEY (`MATRICULA`, `CNPJ_EMPRESA`, `DATA`);
...
ALTER TABLE `REGISTRO_PONTO` ADD CONSTRAINT `FK_REGISTRO_PONTO_CNPJ_EMPRESA` FOREIGN KEY (`CNPJ_EMPRESA`) REFERENCES `COLABORADOR`(`CNPJ_EMPRESA`) ON DELETE RESTRICT ON UPDATE CASCADE;
