...
class _CadastroEmpresaPageState extends State<CadastroEmpresaPage> {
  ...
  Future<void> _cadastrar() async {
    try {
      final senha = await dialogos.mostrarDialogoCadastroSenha(context);
      ...
      if (response.statusCode == 201) {
        ...
        print(
            "Erro ao cadastrar empresa: \${response.statusCode}, Detalhes: \${response.body}");
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text("Erro inesperado ao cadastrar. Tente novamente!")),
      );
    }
  }
